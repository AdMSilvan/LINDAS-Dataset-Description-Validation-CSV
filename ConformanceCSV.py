...
with open('query_result.csv', newline='') as i:
    ...
    with open('Dataset_Description_Validation.csv', "w", newline='') as o:
        ...
        for row in reader:
            ...
            #write row
            if len(row_output) == 15:
                writer.writerow(row_output)
            elif len(row_output) > 15:
